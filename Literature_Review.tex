...
Each cilia and flagella beat with a characteristic rhythm, but studies have shown that in the presence of nearby beating cilia/flagella, the beating can synchronise.\cite{brumleyFlagellarSynchronizationDirect2014} The nature of the coordination is often \textit{metachronal} - that is, sequencial and staggered (different phases), creating the appearance of a travelling wave. A macroscopic example of this is the mexican wave.
\cite{brumleyMetachronalWavesFlagellar2015}

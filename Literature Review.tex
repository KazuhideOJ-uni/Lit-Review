...
\end{definition}
\end{mdframed}
Cilia serve important functions in motility, sensory reception, signalling, and mass transport. Studies of ciliary flows therefore have significant biological implications. 
\cite{mizunoStructuralStudiesCiliary2012} \nl
Key Terms and its synonyms:

\begin{center}
\begin{tabular}[|c|c|c|]
        \hline
        Cilia & Synchronization & Term 3 \\
        \hline
        Flagella & John & Gaming \\
        \hline
\end{tabular}
\end{center}

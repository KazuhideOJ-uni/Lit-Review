...
\end{definition}
\end{mdframed}
(A paragraph about where cilia are found) \nl
\subsection{Corals}
Cilia-induced vortical flows are critical for $\text{O}_2$ regulation and metabolite exchange across coral-water interfaces. Against the backdrop of global sea warming, Pacherres et al. found that ciliary beating is important for thermal tolerance for corals. By beating with higher frequency, the corals increase $\text{O}_2$ intake, which alleviates hypoxia observed in temperatures about 35 C$^{\circ}$ and above. Above about 37 C$^{\circ}$, coral morality accelerated, indicating the existence of a physiological tipping-point for reef-building corals.
\cite{pacherresAcuteTemperatureEffects}
